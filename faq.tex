...
\question{Sportello}\label{tre}
	\begin{itemize}
		...
		\item I giorni 04/07 e 10/07 sono stato allo sportello per l'orientamento in ingresso di SMFN.
		
		In totale sono stato allo sportello per 13 ore.
	\end{itemize}
