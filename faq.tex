...
\question{Sportello}\label{uno}
	\begin{itemize}
		\item Nei mesi di luglio, agosto e settembre sono stato allo sportello per l'orientamento in ingresso di SMFN per un totale di 67 ore.
	\end{itemize}
	
\question{Siti istituzionali}\label{due}
	\begin{itemize}
		\item Il giorno 10/07 ho controllato i contenuti del syllabus dei corsi della magistrale di informatica come richiesto dalla professoressa Verri.
		
		Questo lavoro è durato 1 ora.
	\end{itemize}
	
\question{PF24}\label{tre}
	\begin{itemize}
		\item Il giorno 20/07 ho partecipato all'attività di sorveglianza agli esami PF24.
		
		Sono stato impegnato per 9 ore.
	\end{itemize}

\question{SSM2018}\label{quattro}
\begin{itemize}
	\item Il giorno 16/07 e 17/07 ho partecipato all'attività di allestimento e preparazione dei locali e alla sorveglianza agli esami SSM2018.
	
	Sono stato impegnato in totale per 13 ore.
\end{itemize}

\question{Prova di verifica delle conoscenze}\label{cinque}
\begin{itemize}
	\item Il giorno 13/09 ho partecipato all'attività di identificazione dei candidati alla prova di verifica delle conoscenze in ingresso.
	
	Sono stato impegnato in totale per 8 ore.
\end{itemize}
