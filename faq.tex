...
\question{Sportello}\label{uno}
	\begin{itemize}
		\item I giorni 18-19/07, 03-10/08 e 04-05-12-14-28/09 sono stato allo sportello per l'orientamento in ingresso di SMFN.
		
		In totale sono stato allo sportello per 45 ore.
	\end{itemize}
