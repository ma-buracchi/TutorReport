...
\begin{itemize}
	\item Il giorno 19/02 ho effettuato l'incontro conoscitivo con Patrizia Maranghi e gli altri tutor nel quale abbiamo discusso e organizzato le prime attività da svolgere. Come primo impegno ci sarà il controllo e il miglioramento dei siti dei vari corsi di laurea. Questo incontro è durato circa un'ora.
	\item Il giorno 27/02 ho partecipato all'incontro con
\end{itemize}

\question{Siti istituzionali}\label{due}

Il giorno 27/02 ho iniziato il controllo dei siti istituzionali. Ho rilevato le seguenti criticità:
\begin{itemize}
	\item Prima criticità
	\item Seconda criticità
\end{itemize}

Questo lavoro è durato n ore.
