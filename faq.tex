...
\question{Sportello}\label{uno}
	\begin{itemize}
		\item I giorni 18/07, 19/07, 03/08 e 10/08 sono stato allo sportello per l'orientamento in ingresso di SMFN.
		
		In totale sono stato allo sportello per 20 ore.
	\end{itemize}
...
\begin{itemize}
	\item Il giorno 18/07 e 19/07 ho partecipato all'attività di allestimento e preparazione dei locali e alla sorveglianza agli esami SSM2018.
