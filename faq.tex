...
\question{Sportello}\label{uno}
	\begin{itemize}
		\item I giorni 18/07 e 19/07 sono stato allo sportello per l'orientamento in ingresso di SMFN.
		
		In totale sono stato allo sportello per 10 ore.
	\end{itemize}
...
\begin{itemize}
	...
	Sono stato impegnato in totale per 12 ore.
\end{itemize}
